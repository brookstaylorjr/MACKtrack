function [output, diagnos] =  primaryID(nuc_orig,p)
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
% [output, diagnos] =  primaryID(nuc_orig,p,data,~) 
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
% PRIMARYID  Find nuclei from images of nuclear-localized fluorophore. Creates separated mask of identified nuclei.
% (works identically to nucleusID, but guesses at serach region using an expanded/lenient threshold of the image)
%
...
edge_cutoffs = prctile(diagnos.edge_mag(diagnos.edge_mag>p.NucleusEdgeThreshold),0:10:80);
unique_all = 0;
...
output.nuclei = diagnos.label1+diagnos.label2;
