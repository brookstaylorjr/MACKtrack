function [graph, info, measure] = see_translocation_dim(id,show_graphs, diagnos)
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
% VISUALIZEID pull measurements from set, do most common cell filtering steps, and 
% (optionally) show behavior graphs
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
if nargin<3
    diagnos=0;
    if nargin<2
...
% Display parameters
t_hrs = 15; % Number of hours to display in graphs
